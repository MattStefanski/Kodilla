...
package com.kodilla.good.patterns.airline.finder;
...
public class FlightFinder {
    ...
    public void listByDepartureAirport(FlightSchedule schedule, String departureAirport) {
        ...
        schedule.getSchedule()
                .entrySet()
                .stream()
                .filter(m -> m.getValue().getConnection().getDepartureAirport().equals(departureAirport))
    ...
    public void listByArrivalAirport(FlightSchedule schedule, String arrivalAirport) {
        ...
        schedule.getSchedule()
                .entrySet()
                .stream()
                .filter(m -> m.getValue().getConnection().getArrivalAirport().equals(arrivalAirport))
                .forEach(m -> System.out.println(m.getValue().toString()));
